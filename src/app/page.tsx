...
//         {/* Test Components */}
//         <main className="lg:w-2/3 w-full space-y-10">
//           <CameraTest onCameraStatusChange={setIsCameraOn} />
//           <MicrophoneTest onMicStatusChange={setIsMicOn} />
//           <NetworkTest onNetworkStats={setNetworkStats} />
...
return (
  <div className="p-6 relative">
    {/* Start Interview button at top-right (fixed position) */}
    <div className="absolute top-6 right-6">
      <StartInterview isReady={isReady} message={message} />
    </div>

    {/* Everything else shifted 50px down */}
